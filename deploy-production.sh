...
gcloud docker -- push eu.gcr.io/${PROJECT_NAME_PRD}/${DOCKER_IMAGE_NAME_DINNER}
gcloud docker -- push eu.gcr.io/${PROJECT_NAME_PRD}/${DOCKER_IMAGE_NAME_AUTH}
gcloud docker -- push eu.gcr.io/${PROJECT_NAME_PRD}/${DOCKER_IMAGE_NAME_GATEWAY}
gcloud docker -- push eu.gcr.io/${PROJECT_NAME_PRD}/${DOCKER_IMAGE_NAME_USER}
