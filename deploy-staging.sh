...
docker build -t eu.gcr.io/${PROJECT_NAME_STG}/${DOCKER_IMAGE_NAME_DINNER}:$TRAVIS_COMMIT .
cd ../../..

cd backend/auth/auth-core
docker build -t eu.gcr.io/${PROJECT_NAME_STG}/${DOCKER_IMAGE_NAME_AUTH}:$TRAVIS_COMMIT .
cd ../../..

cd backend/gateway
docker build -t eu.gcr.io/${PROJECT_NAME_STG}/${DOCKER_IMAGE_NAME_GATEWAY}:$TRAVIS_COMMIT .
cd ../..

cd backend/user/user-core
docker build -t eu.gcr.io/${PROJECT_NAME_STG}/${DOCKER_IMAGE_NAME_USER}:$TRAVIS_COMMIT .
cd ../../..

cd frontend/
docker build -t eu.gcr.io/${PROJECT_NAME_STG}/${DOCKER_IMAGE_NAME_FRONTEND}:$TRAVIS_COMMIT .
cd ..
...
docker push eu.gcr.io/${PROJECT_NAME_STG}/${DOCKER_IMAGE_NAME_DINNER}
docker push eu.gcr.io/${PROJECT_NAME_STG}/${DOCKER_IMAGE_NAME_AUTH}
docker push eu.gcr.io/${PROJECT_NAME_STG}/${DOCKER_IMAGE_NAME_GATEWAY}
docker push eu.gcr.io/${PROJECT_NAME_STG}/${DOCKER_IMAGE_NAME_USER}
docker push eu.gcr.io/${PROJECT_NAME_STG}/${DOCKER_IMAGE_NAME_FRONTEND}
...
yes | gcloud beta container images add-tag eu.gcr.io/${PROJECT_NAME_STG}/${DOCKER_IMAGE_NAME_GATEWAY}:$TRAVIS_COMMIT eu.gcr.io/${PROJECT_NAME_STG}/${DOCKER_IMAGE_NAME_GATEWAY}:latest
yes | gcloud beta container images add-tag eu.gcr.io/${PROJECT_NAME_STG}/${DOCKER_IMAGE_NAME_USER}:$TRAVIS_COMMIT eu.gcr.io/${PROJECT_NAME_STG}/${DOCKER_IMAGE_NAME_USER}:latest
yes | gcloud beta container images add-tag eu.gcr.io/${PROJECT_NAME_STG}/${DOCKER_IMAGE_NAME_FRONTEND}:$TRAVIS_COMMIT eu.gcr.io/${PROJECT_NAME_STG}/${DOCKER_IMAGE_NAME_FRONTEND}:latest

kubectl config view
kubectl config current-context

kubectl create configmap nginx-configmap --from-file=$PWD/deployments/staging/nginx.conf -o yaml --dry-run > $PWD/deployments/staging/nginx-configmap.yml
